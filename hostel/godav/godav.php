...
$sql4="SELECT * FROM Contacts WHERE Hostel_id=4 and S_no=4";
$sql5="SELECT * FROM Contacts WHERE Hostel_id=4 and S_no=5";
$sql6="SELECT * FROM Contacts WHERE Hostel_id=4 and S_no=6";
$sql7="SELECT * FROM Contacts WHERE Hostel_id=4 and S_no=7";
$sql8="SELECT * FROM Contacts WHERE Hostel_id=4 and S_no=8";
...
<html>
	<head>
		...
		<link href="css/godav.css" rel="stylesheet">
		<script type="text/javascript" src="js/godav.js"></script>
		<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css" >
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
		<script src="js/bootstrap.js"></script>
		<script src="js/godav.js"></script>
		<script src="http://maps.googleapis.com/maps/api/js"></script>
		<script >
		var myCenter=new google.maps.LatLng(12.985892, 80.237070);
		...
		<div id="godav" class="carousel slide">
			...
			<div class="carousel-inner">
				...
				<div class="item active">
					<div class="container">
						<img src="img/slide1.jpg" class="image">
					</div>
					<div class="container">
