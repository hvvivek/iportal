...
$sql1="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=1";
$sql2="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=2";
$sql3="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=3";
$sql4="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=4";
$sql5="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=5";
$sql6="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=6";
$sql7="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=7";
$sql8="SELECT * FROM Contacts WHERE Hostel_id=7 and S_no=8";
