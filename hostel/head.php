		...
		<div class="container-fluid">
				<div class="sidebar col-md-2">
					<ul class="nav nav-sidebar">
							...
							<li class="bull"><a href='hostel.php?varname=<?php echo $id;?>' class="kill">Hostel secretaries details</a></li>
...
<?php
          ...
          while($sno<=5)
          {
            $query="SELECT * FROM staff WHERE hostel_id='{$id}' and s_no='{$sno}'";
                      ...
                      echo "
                          ...
                          echo "</p>
                              ...
                              <div class='col-md-4 col-sm-6 screen slum'>
                                                <div class='header'>
                                                                    <p class='oned padnone'>".$staff['post']."</p>
                                                                                      </div>
                                                                                                        <div class='slider'>
                                                                                                                            <div id='s1'>
                                                                                                                                                  <div class='header1'>
