...
$sql1="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=1";
$sql2="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=2";
$sql3="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=3";
$sql4="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=4";
$sql5="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=5";
$sql6="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=6";
$sql7="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=7";
$sql8="SELECT * FROM Contacts WHERE Hostel_id=6 and S_no=8";
...
<html>
	<head>
		...
		<title>Godavari hostel</title>
		<link href="css/bootstrap.min.css" rel="stylesheet">
		<link href="css/saras.css" rel="stylesheet">
		<script type="text/javascript" src="js/godav.js"></script>
		<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css" >
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
		<script src="js/bootstrap.js"></script>
		<script src="js/saras.js"></script>
		<script src="http://maps.googleapis.com/maps/api/js"></script>
		<script >
		var myCenter=new google.maps.LatLng(12.984942, 80.236520);
