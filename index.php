...
<form id="fid3" action="hostel/hostel.php">
	...
	<a href="#" onclick="document.getElementById('fid3').submit();"><div class="small2"><p class="smtext2">cav</p></div></a>
</form>
<form id="fid4" action="hostel/hostel.php">
	...
	<a href="#" onclick="document.getElementById('fid4').submit();"><div class="small2"><p class="smtext2">gang</p></div></a>
</form>
...
<form id="fid10" action="hostel/hostel.php">
	...
	<a href="#" onclick="document.getElementById('fid10').submit();"><div class="small2"><p class="smtext2">nar</p></div></a>
</form>
...
<form id="fid12" action="hostel/hostel.php">
	...
	<a href="#" onclick="document.getElementById('fid12').submit();"><div class="small2"><p class="smtext2">sar</p></div></a>
</form>
...
<form id="fid14" action="hostel/hostel.php">
	...
	<a href="#" onclick="document.getElementById('fid14').submit();"><div class="small2"><p class="smtext2">sha</p></div></a>
</form>
...
<form id="fid17" action="hostel/hostel.php">
	...
	<a href="#" onclick="document.getElementById('fid17').submit();"><div class="small2"><p class="smtext2">tpt</p></div></a>
</form>
</div>
<div class="contain3">
<div class="blurmenu" ></div>
